    ...
    private static async Task ApplyPostgresAsync(ApplicationDbContext dbContext, ILogger logger)
    {
        ...
        await dbContext.Database.ExecuteSqlRawAsync(
            ...
            CREATE TABLE IF NOT EXISTS "Users" (
                ...
                "HmacKeyCiphertext" bytea NULL,
                "HmacKeyNonce" bytea NULL,
                "HmacKeyTag" bytea NULL,
                "CreatedAtUtc" timestamp with time zone NOT NULL,
        ...
        await dbContext.Database.ExecuteSqlRawAsync(
            ...
            CREATE TABLE IF NOT EXISTS "GpsPositions" (
                ...
                CONSTRAINT "FK_GpsPositions_Users_UserId" FOREIGN KEY ("UserId") REFERENCES "Users" ("Id") ON DELETE CASCADE
            );
            """);

        await dbContext.Database.ExecuteSqlRawAsync(
            """
            CREATE INDEX IF NOT EXISTS "IX_GpsPositions_UserId_Timestamp" ON "GpsPositions" ("UserId", "Timestamp");
            """);

        await dbContext.Database.ExecuteSqlRawAsync(
            """
            CREATE UNIQUE INDEX IF NOT EXISTS "IX_GpsPositions_UserId_SequenceNumber" ON "GpsPositions" ("UserId", "SequenceNumber");
            """);

        await dbContext.Database.ExecuteSqlRawAsync(
            """
            CREATE TABLE IF NOT EXISTS "DetectedPersons" (
                "Id" bigserial PRIMARY KEY,
                "UserId" integer NOT NULL,
                "TargetUserId" integer NULL,
                "IsAlly" boolean NOT NULL,
                "Label" varchar(64) NOT NULL DEFAULT 'person',
                ...
                "SequenceNumber" bigint NOT NULL,
                "Timestamp" timestamp with time zone NOT NULL,
                CONSTRAINT "FK_DetectedPersons_Users_UserId" FOREIGN KEY ("UserId") REFERENCES "Users" ("Id") ON DELETE CASCADE,
                CONSTRAINT "FK_DetectedPersons_Users_TargetUserId" FOREIGN KEY ("TargetUserId") REFERENCES "Users" ("Id") ON DELETE SET NULL
            );
            """);

        await dbContext.Database.ExecuteSqlRawAsync(
            """
            CREATE INDEX IF NOT EXISTS "IX_DetectedPersons_UserId_Timestamp" ON "DetectedPersons" ("UserId", "Timestamp");
            """);
...
CREATE TABLE IF NOT EXISTS Users (
    ...
    HmacKeyCiphertext BLOB NULL,
    HmacKeyNonce BLOB NULL,
    HmacKeyTag BLOB NULL,
    CreatedAtUtc TEXT NOT NULL,
    LastLoginAtUtc TEXT NULL
);");
        await dbContext.Database.ExecuteSqlRawAsync("CREATE UNIQUE INDEX IF NOT EXISTS IX_Users_Login ON Users (Login);");

        await dbContext.Database.ExecuteSqlRawAsync(@"
CREATE TABLE IF NOT EXISTS GpsPositions (
    Id INTEGER NOT NULL CONSTRAINT PK_GpsPositions PRIMARY KEY AUTOINCREMENT,
    UserId INTEGER NOT NULL,
    ...
    FOREIGN KEY (UserId) REFERENCES Users (Id) ON DELETE CASCADE
        ...
        await dbContext.Database.ExecuteSqlRawAsync("CREATE INDEX IF NOT EXISTS IX_GpsPositions_UserId_Timestamp ON GpsPositions (UserId, Timestamp);");
        await dbContext.Database.ExecuteSqlRawAsync("CREATE UNIQUE INDEX IF NOT EXISTS IX_GpsPositions_UserId_SequenceNumber ON GpsPositions (UserId, SequenceNumber);");

        await dbContext.Database.ExecuteSqlRawAsync(@"
CREATE TABLE IF NOT EXISTS DetectedPersons (
    Id INTEGER NOT NULL CONSTRAINT PK_DetectedPersons PRIMARY KEY AUTOINCREMENT,
    UserId INTEGER NOT NULL,
    TargetUserId INTEGER NULL,
    ...
    FOREIGN KEY (TargetUserId) REFERENCES Users (Id) ON DELETE SET NULL
        ...
        await dbContext.Database.ExecuteSqlRawAsync("CREATE INDEX IF NOT EXISTS IX_DetectedPersons_UserId_Timestamp ON DetectedPersons (UserId, Timestamp);");
